...
const Headermain = () => {
    return (
        <div className="d-flex flex-column text-center text-white">
            <h1 class="display-3">Hello, I am <span className="highlight-text">Sumita</span></h1>
            <p className="lead">A self-motivated, energetic and active person,<br /> I want to be a perfect aiding-hand of your organization<br /> according to my qualifications during my job.</p>
